package com.excel.dao_02._02JdbcTemplateDaoQueries;
...
public class   SelectClient {
	public static void main(String args[])throws Exception {
		ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("com/excel/dao_02/_02JdbcTemplateDaoQueries/applicationContext.xml");
		SelectImple s=(SelectImple)ctx.getBean("sel");
		System.out.println("Employee count with Clerk disgnation is: "+s.getEmpCount("AD_PRES"));
		Map m = s.getEmpDetails(100);
		System.out.println("Details of empno: 100 are: "+m.toString());
		
		System.out.println("Clerk designation employees details are: ");
		
		List l = s.getEmpDetails("AD_VP");
