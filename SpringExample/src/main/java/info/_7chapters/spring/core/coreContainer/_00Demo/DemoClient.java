package info._7chapters.spring.core.coreContainer._00Demo;
...
//		System.out.println(comp.logoName());
		...
		Resource  res = new ClassPathResource("info/_7chapters/spring/core/coreContainer/_00Demo/applicationContext.xml");
